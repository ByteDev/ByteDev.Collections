...
namespace ByteDev.Collections
{
    ...
    {
        /// <summary>
        /// Get the longest string in <paramref name="source" />; otherwise null if <paramref name="source" /> is empty.
        /// </summary>
        ...
        /// <summary>
        /// Get the shortest string in <paramref name="source" />; otherwise null if <paramref name="source" /> is empty.
        /// </summary>
